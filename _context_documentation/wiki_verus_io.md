...
### `getaddresstxids`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getaddresstxids)
...
#### Result (for verbosity = 2):[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Result_(for_verbosity_=_2):)
...
#### Result (for verbose=false):[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Result_(for_verbose=false):)
...
### `gettxout "txid" n ( includemempool )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#gettxout_%22txid%22_n_(_includemempool_))
...
## `gettxoutproof ["txid",...] ( blockhash )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#gettxoutproof_[%22txid%22,...]_(_blockhash_))
...
### `getidentitytrust '["id",...]'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getidentitytrust_'[%22id%22,...]')
...
### `updateidentity "jsonidentity" (returntx) (tokenupdate) (feeoffer) (sourceoffunds)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#updateidentity_%22jsonidentity%22_(returntx)_(tokenupdate)_(feeoffer)_(sourceoffunds))
...
### `verifyfile "address or identity" "signature" "filepath/filename" "checklatest"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#verifyfile_%22address_or_identity%22_%22signature%22_%22filepath/filename%22_%22checklatest%22)
...
4. "checklatest" (bool, optional) If true, checks signature validity based on latest identity. defaults to false, which determines validity of signing height stored in signature.
...
### `verifyhash "address or identity" "signature" "hexhash" "checklatest"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#verifyhash_%22address_or_identity%22_%22signature%22_%22hexhash%22_%22checklatest%22)
...
### `verifymessage "address or identity" "signature" "message" "checklatest"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#verifymessage_%22address_or_identity%22_%22signature%22_%22message%22_%22checklatest%22)
...
### `Verifysignature 'json'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Verifysignature_'json')
...
### `closeoffers ('["offer1_txid", "offer2_txid", ...]') (transparentorprivatefundsdestination) (privatefundsdestination)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#closeoffers_('[%22offer1_txid%22,_%22offer2_txid%22,_...]')_(transparentorprivatefundsdestination)_(privatefundsdestination))
...
### `getoffers "currencyorid" (iscurrency) (withtx)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getoffers_%22currencyorid%22_(iscurrency)_(withtx))
...
### `listopenoffers (unexpired) (expired)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listopenoffers_(unexpired)_(expired))
...
### `makeoffer fromaddress '{"changeaddress":"transparentoriaddress", "expiryheight":blockheight, "offer":{"currency":"anycurrency", "amount":...} | {"identity":"idnameoriaddress",...}', "for":{"address":..., "currency":"anycurrency", "amount":...} | {"name":"identityforswap","parent":"parentid","primaryaddresses":["R-address(s)"],"minimumsignatures":1,...}}' (returntx) (feeamount)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#makeoffer_fromaddress_'{%22changeaddress%22:%22transparentoriaddress%22,_%22expiryheight%22:blockheight,_%22offer%22:{%22currency%22:%22anycurrency%22,_%22amount%22:...}_|_{%22identity%22:%22idnameoriaddress%22,...}',_%22for%22:{%22address%22:...,_%22currency%22:%22anycurrency%22,_%22amount%22:...}_|_{%22name%22:%22identityforswap%22,%22parent%22:%22parentid%22,%22primaryaddresses%22:[%22R-address(s)%22],%22minimumsignatures%22:1,...}}'_(returntx)_(feeamount))
...
### `takeoffer fromaddress '{"txid":"txid" | "tx":"hextx", "changeaddress":"transparentoriaddress", "deliver":"fullidnameoriaddresstodeliver" | {"currency":"currencynameorid","amount":n}, "accept":{"address":"addressorid","currency":"currencynameorid","amount"} | {identitydefinition}}' (returntx) (feeamount)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#takeoffer_fromaddress_'{%22txid%22:%22txid%22_|_%22tx%22:%22hextx%22,_%22changeaddress%22:%22transparentoriaddress%22,_%22deliver%22:%22fullidnameoriaddresstodeliver%22_|_{%22currency%22:%22currencynameorid%22,%22amount%22:n},_%22accept%22:{%22address%22:%22addressorid%22,%22currency%22:%22currencynameorid%22,%22amount%22}_|_{identitydefinition}}'_(returntx)_(feeamount))
...
### `getblocksubsidy height`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getblocksubsidy_height)
...
### `getblocktemplate ( "jsonrequestobject" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getblocktemplate_(_%22jsonrequestobject%22_))

If the request parameters include a 'mode' key, that is used to explicitly select between the default 'template' request or a 'proposal'.

It returns data needed to construct a block to work on.

See [https://en.bitcoin.it/wiki/BIP\_0022](https://en.bitcoin.it/wiki/BIP_0022) for full specification.
...
### `getlocalsolps`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getlocalsolps)
...
### `getminingdistribution`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getminingdistribution)
...
### `getmininginfo`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getmininginfo)
...
### `getnetworkhashps ( blocks height )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnetworkhashps_(_blocks_height_))
...
### `getnetworksolps ( blocks height )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnetworksolps_(_blocks_height_))
...
### `prioritisetransaction <txid> <priority delta> <fee delta>`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#prioritisetransaction_%3Ctxid%3E_%3Cpriority_delta%3E_%3Cfee_delta%3E)
...
### `setminingdistribution ( "jsonminingdistribution" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#setminingdistribution_(_%22jsonminingdistribution%22_))
...
### `submitblock "hexdata" ( "jsonparametersobject" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#submitblock_%22hexdata%22_(_%22jsonparametersobject%22_))
...
### `addmergedblock "hexdata" ( "jsonparametersobject" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#addmergedblock_%22hexdata%22_(_%22jsonparametersobject%22_))
...
### `definecurrency '{"name": "coinortokenname", ..., "nodes":[{"networkaddress":"identity"},..]}' '({"name": "fractionalgatewayname", ..., })' ({"name": "reserveonename", ..., }) ...`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#definecurrency_'{%22name%22:_%22coinortokenname%22,_...,_%22nodes%22:[{%22networkaddress%22:%22identity%22},..]}'_'({%22name%22:_%22fractionalgatewayname%22,_...,_})'_({%22name%22:_%22reserveonename%22,_...,_})_...)
...
### `estimateconversion '{"currency":"name","convertto":"name","amount":n}'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#estimateconversion_'{%22currency%22:%22name%22,%22convertto%22:%22name%22,%22amount%22:n}')
...
### `getbestproofroot '{"proofroots":["version":n,"type":n,"systemid":"currencyidorname","height":n, "stateroot":"hex","blockhash":"hex","power":"hex"],"lastconfirmed":n}'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getbestproofroot_'{%22proofroots%22:[%22version%22:n,%22type%22:n,%22systemid%22:%22currencyidorname%22,%22height%22:n,_%22stateroot%22:%22hex%22,%22blockhash%22:%22hex%22,%22power%22:%22hex%22],%22lastconfirmed%22:n}')
...
### `getcurrency "currencyname"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getcurrency_%22currencyname%22)
...
### `getcurrencyconverters "currency1" "currency2" ... | 'json object'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getcurrencyconverters_%22currency1%22_%22currency2%22_..._|_'json_object')
...
### `getcurrencystate "currencynameorid" ("n | m,n | m,n,o") ("connectedsystemid")`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getcurrencystate_%22currencynameorid%22_(%22n_|_m,n_|_m,n,o%22)_(%22connectedsystemid%22))
...
### `getcurrencytrust '["currencyid",...]'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getcurrencytrust_'[%22currencyid%22,...]')
...
### `getexports "chainname" (heightstart) (heightend)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getexports_%22chainname%22_(heightstart)_(heightend))
...
### `getimports "chainname" (startheight) (endheight)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getimports_%22chainname%22_(startheight)_(endheight))
...
### `getinitialcurrencystate "name"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getinitialcurrencystate_%22name%22)
...
### `getlastimportfrom "systemname"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getlastimportfrom_%22systemname%22)
...
### `getlaunchinfo "currencyid"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getlaunchinfo_%22currencyid%22)
...
### `getnotarizationdata "currencyid" (getevidence) (separatecounterevidence)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnotarizationdata_%22currencyid%22_(getevidence)_(separatecounterevidence))
...
### `getnotarizationproofs {json object}`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnotarizationproofs_{json_object})
...
### `getpendingtransfers "chainname"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getpendingtransfers_%22chainname%22)
...
### `getreservedeposits "currencyname"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getreservedeposits_%22currencyname%22)
...
### `getsaplingtree "n | m,n | m,n,o"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getsaplingtree_%22n_|_m,n_|_m,n,o%22)
...
### `listcurrencies ({query object}) startblock endblock`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listcurrencies_({query_object})_startblock_endblock)
...
### `refundfailedlaunch "currencyid"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#refundfailedlaunch_%22currencyid%22)
...
### `sendcurrency "fromaddress" '[{"address":... ,"amount":...},...]' (minconfs) (feeamount) (returntxtemplate)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#sendcurrency_%22fromaddress%22_'[{%22address%22:..._,%22amount%22:...},...]'_(minconfs)_(feeamount)_(returntxtemplate))
...
1. "operationid" (string) An operationid to pass to z\_getoperationstatus to get the result of the operation.
...
### `setcurrencytrust '{"clearall": bool, "setratings":[{"currencyid":JSONRatingObject},...], "removeratings":["currencyid",...], "currencytrustmode":<n>}`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#setcurrencytrust_'{%22clearall%22:_bool,_%22setratings%22:[{%22currencyid%22:JSONRatingObject},...],_%22removeratings%22:[%22currencyid%22,...],_%22currencytrustmode%22:%3Cn%3E})
...
### `submitacceptednotarization "{earnednotarization}" "{notaryevidence}"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#submitacceptednotarization_%22{earnednotarization}%22_%22{notaryevidence}%22)
...
### `submitchallenges [json array]`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#submitchallenges_[json_array])
...
### `submitimports '{"sourcesystemid":"systemid", "notarizationtxid":"txid", "notarizationtxoutnum":n, "exports":[{"txid":"hexid", "txoutnum":n, "partialtransactionproof":"hexstr", Fresendw"transfers": [{transfer1}, {transfer2},...]}, ...]}'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#submitimports_'{%22sourcesystemid%22:%22systemid%22,_%22notarizationtxid%22:%22txid%22,_%22notarizationtxoutnum%22:n,_%22exports%22:[{%22txid%22:%22hexid%22,_%22txoutnum%22:n,_%22partialtransactionproof%22:%22hexstr%22,_Fresendw%22transfers%22:_[{transfer1},_{transfer2},...]},_...]}')
...
### `submitmergedblock "hexdata" ( "jsonparametersobject" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#submitmergedblock_%22hexdata%22_(_%22jsonparametersobject%22_))
...
### `addnode "node" "add|remove|onetry"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#addnode_%22node%22_%22add|remove|onetry%22)
...
### `clearbanned`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#clearbanned)
...
### `disconnectnode "node"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#disconnectnode_%22node%22)
...
### `getaddednodeinfo dns ( "node" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getaddednodeinfo_dns_(_%22node%22_))
...
### `getconnectioncount`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getconnectioncount)
...
### `getdeprecationinfo`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getdeprecationinfo)
...
### `getnettotals`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnettotals)
...
### `getnetworkinfo`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnetworkinfo)
...
### `getpeerinfo`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getpeerinfo)
...
### `listbanned`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listbanned)
...
### `ping`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#ping)
...
### `setban "ip(/netmask)" "add|remove" (bantime) (absolute)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#setban_%22ip(/netmask)%22_%22add|remove%22_(bantime)_(absolute))
...
### `createrawtransaction [{"txid":"id","vout":n},...] {"address":amount,...} ( locktime ) ( expiryheight )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#createrawtransaction_[{%22txid%22:%22id%22,%22vout%22:n},...]_{%22address%22:amount,...}_(_locktime_)_(_expiryheight_))
...
### `decoderawtransaction "hexstring"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#decoderawtransaction_%22hexstring%22)
...
### `decodescript "hex"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#decodescript_%22hex%22)
...
### `fundrawtransaction "hexstring" '[{"txid":"8892b6c090b51a4eed7a61b72e9c8dbf5ed5bcd5aca6c6819b630acf2cb3fc87","voutnum":1},...]' (changeaddress) (explicitfee)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#fundrawtransaction_%22hexstring%22_'[{%22txid%22:%228892b6c090b51a4eed7a61b72e9c8dbf5ed5bcd5aca6c6819b630acf2cb3fc87%22,%22voutnum%22:1},...]'_(changeaddress)_(explicitfee))
...
### `getrawtransaction "txid" ( verbose )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getrawtransaction_%22txid%22_(_verbose_))
...
#### Result (if verbose > 0):[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Result_(if_verbose_%3E_0):)
...
### `sendrawtransaction "hexstring" ( allowhighfees )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#sendrawtransaction_%22hexstring%22_(_allowhighfees_))
...
### `signrawtransaction "hexstring" ( [{"txid":"id","vout":n,"scriptPubKey":"hex","redeemScript":"hex"},...] ["privatekey1",...] sighashtype )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#signrawtransaction_%22hexstring%22_(_[{%22txid%22:%22id%22,%22vout%22:n,%22scriptPubKey%22:%22hex%22,%22redeemScript%22:%22hex%22},...]_[%22privatekey1%22,...]_sighashtype_))
...
### `createmultisig nrequired ["key",...]`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#createmultisig_nrequired_[%22key%22,...])
...
### `estimatefee nblocks`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#estimatefee_nblocks)
...
### `estimatepriority nblocks`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#estimatepriority_nblocks)
...
### `invalidateblock "hash"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#invalidateblock_%22hash%22)
...
### `jumblr_deposit "depositaddress"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#jumblr_deposit_%22depositaddress%22)

### `jumblr_pause`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#jumblr_pause)

### `jumblr_resume`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#jumblr_resume)

### `jumblr_secret "secretaddress"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#jumblr_secret_%22secretaddress%22)

### `reconsiderblock "hash"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#reconsiderblock_%22hash%22)
...
### `validateaddress "verusaddress"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#validateaddress_%22verusaddress%22)
...
### `z_validateaddress "zaddr"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_validateaddress_%22zaddr%22)
...
### `getvdxfid "vdxfuri" '{"vdxfkey":"i-address or vdxfkey", "uint256":"hexstr", "indexnum":0}'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getvdxfid_%22vdxfuri%22_'{%22vdxfkey%22:%22i-address_or_vdxfkey%22,_%22uint256%22:%22hexstr%22,_%22indexnum%22:0}')
...
### `addmultisigaddress nrequired ["key",...] ( "account" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#addmultisigaddress_nrequired_[%22key%22,...]_(_%22account%22_))
...
"VRSC\_address" (string) A VRSC address associated with the keys.
...
### `backupwallet "destination"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#backupwallet_%22destination%22)
...
### `convertpassphrase "walletpassphrase"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#convertpassphrase_%22walletpassphrase%22)
...
### `decryptdata 'json object'` **_`NEW`_**[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#decryptdata_'json_object'_NEW)
...
### `dumpprivkey "t-addr"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#dumpprivkey_%22t-addr%22)
...
### `dumpwallet "filename" (omitemptytaddresses)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#dumpwallet_%22filename%22_(omitemptytaddresses))
...
### `encryptwallet "passphrase"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#encryptwallet_%22passphrase%22)
...
### `getaccount "VRSC_address"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getaccount_%22VRSC_address%22)

DEPRECATED. Returns the account associated with the given address.

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. "VRSC\_address" (string, required) The VRSC address for account lookup.
...
### `getaccountaddress "account"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getaccountaddress_%22account%22)
...
"VRSC\_address" (string) The account VRSC address
...
### `getaddressesbyaccount "account"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getaddressesbyaccount_%22account%22)
...
### `getbalance ( "account" minconf includeWatchonly )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getbalance_(_%22account%22_minconf_includeWatchonly_))
...
### `getcurrencybalance "address" ( minconf ) ( friendlynames ) (includeshared)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getcurrencybalance_%22address%22_(_minconf_)_(_friendlynames_)_(includeshared))
...
### `getnewaddress ( "account" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getnewaddress_(_%22account%22_))
...
"VRSC\_address" (string) The new VRSC address
...
### `getrawchangeaddress`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getrawchangeaddress)
...
### `getreceivedbyaccount "account" ( minconf )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getreceivedbyaccount_%22account%22_(_minconf_))
...
### `getreceivedbyaddress "VRSC_address" ( minconf )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getreceivedbyaddress_%22VRSC_address%22_(_minconf_))

Returns the total amount received by the given VRSC address in transactions with at least minconf confirmations.

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. "VRSC\_address" (string, required) The VRSC address for transactions.
2. minconf (numeric, optional, default=1) Only include transactions confirmed at least this many times.
...
### `gettransaction "txid" ( includeWatchonly )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#gettransaction_%22txid%22_(_includeWatchonly_))
...
### `getunconfirmedbalance`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getunconfirmedbalance)

Returns the server's total unconfirmed balance

### `getwalletinfo`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#getwalletinfo)
...
### `importaddress "address" ( "label" rescan )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#importaddress_%22address%22_(_%22label%22_rescan_))
...
### `importprivkey "verusprivkey" ( "label" rescan )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#importprivkey_%22verusprivkey%22_(_%22label%22_rescan_))
...
### `importwallet "filename"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#importwallet_%22filename%22)
...
### `keypoolrefill ( newsize )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#keypoolrefill_(_newsize_))
...
### `listaccounts ( minconf includeWatchonly)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listaccounts_(_minconf_includeWatchonly))
...
### `listaddressgroupings`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listaddressgroupings)
...
### `listlockunspent`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listlockunspent)
...
### `listreceivedbyaccount ( minconf includeempty includeWatchonly)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listreceivedbyaccount_(_minconf_includeempty_includeWatchonly))
...
### `listreceivedbyaddress ( minconf includeempty includeWatchonly)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listreceivedbyaddress_(_minconf_includeempty_includeWatchonly))
...
### `listsinceblock ( "blockhash" target-confirmations includeWatchonly)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listsinceblock_(_%22blockhash%22_target-confirmations_includeWatchonly))
...
### `listtransactions ( "account" count from includeWatchonly)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listtransactions_(_%22account%22_count_from_includeWatchonly))
...
### `listunspent ( minconf maxconf  ["address",...] inludeshared )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#listunspent_(_minconf_maxconf__[%22address%22,...]_inludeshared_))
...
### `lockunspent unlock [{"txid":"txid","vout":n},...]`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#lockunspent_unlock_[{%22txid%22:%22txid%22,%22vout%22:n},...])
...
### `move "fromaccount" "toaccount" amount ( minconf "comment" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#move_%22fromaccount%22_%22toaccount%22_amount_(_minconf_%22comment%22_))
...
### `prunespentwallettransactions "txid"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#prunespentwallettransactions_%22txid%22)
...
### `rescanfromheight (height)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#rescanfromheight_(height))
...
### `resendwallettransactions`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#resendwallettransactions)
...
### `sendfrom "fromaccount" "toVRSCaddress" amount ( minconf "comment" "comment-to" )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#sendfrom_%22fromaccount%22_%22toVRSCaddress%22_amount_(_minconf_%22comment%22_%22comment-to%22_))
...
### `sendmany "fromaccount" {"address":amount,...} ( minconf "comment" ["address",...] )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#sendmany_%22fromaccount%22_{%22address%22:amount,...}_(_minconf_%22comment%22_[%22address%22,...]_))
...
### `sendtoaddress "VRSC_address" amount ( "comment" "comment-to" subtractfeefromamount )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#sendtoaddress_%22VRSC_address%22_amount_(_%22comment%22_%22comment-to%22_subtractfeefromamount_))

Send an amount to a given address. The amount is a real and is rounded to the nearest 0.00000001

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. "VRSC\_address" (string, required) The VRSC address to send to.
...
### `setaccount "VRSC_address" "account"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#setaccount_%22VRSC_address%22_%22account%22)

DEPRECATED. Sets the account associated with the given address.

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. "VRSC\_address" (string, required) The VRSC address to be associated with an account.
...
### `settxfee amount`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#settxfee_amount)
...
### `z_exportkey "zaddr"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_exportkey_%22zaddr%22)
...
### `z_exportviewingkey "zaddr"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_exportviewingkey_%22zaddr%22)
...
### `z_exportwallet "filename" (omitemptytaddresses)`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_exportwallet_%22filename%22_(omitemptytaddresses))
...
### `z_getbalance "address" ( minconf )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_getbalance_%22address%22_(_minconf_))
...
### `z_getnewaddress ( type )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_getnewaddress_(_type_))
...
"VRSC\_address" (string) The new shielded address.
...
### `z_getoperationresult '["operationid", ... ]'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_getoperationresult_'[%22operationid%22,_..._]')
...
### `z_getoperationstatus '["operationid", ... ]'`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_getoperationstatus_'[%22operationid%22,_..._]')
...
### `z_gettotalbalance ( minconf includeWatchonly )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_gettotalbalance_(_minconf_includeWatchonly_))
...
2. includeWatchonly (bool, optional, default=false) Also include balance in watchonly addresses (see 'importaddress' and 'z\_importviewingkey')
...
### `z_importkey "zkey" ( rescan startHeight )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_importkey_%22zkey%22_(_rescan_startHeight_))

Adds a zkey (as returned by z\_exportkey) to your wallet.

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. "zkey" (string, required) The zkey (see z\_exportkey)
...
### `z_importviewingkey "vkey" ( rescan startHeight )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_importviewingkey_%22vkey%22_(_rescan_startHeight_))

Adds a viewing key (as returned by z\_exportviewingkey) to your wallet.

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. "vkey" (string, required) The viewing key (see z\_exportviewingkey)
2. rescan (string, optional, default="whenkeyisnew") Rescan the wallet for transactions - can be "yes", "no" or "whenkeyisnew"
3. startHeight (numeric, optional, default=0) Block height to start rescan from
...
### `z_importwallet "filename"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_importwallet_%22filename%22)

Imports taddr and zaddr keys from a wallet export file (see z\_exportwallet).
...
### `z_listaddresses ( includeWatchonly )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_listaddresses_(_includeWatchonly_))

Returns the list of Sprout and Sapling shielded addresses belonging to the wallet.

#### Arguments:[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#Arguments:)

1. includeWatchonly (bool, optional, default=false) Also include watchonly addresses (see 'z\_importviewingkey')
...
### `z_listoperationids`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_listoperationids)
...
### `z_listreceivedbyaddress "address" ( minconf )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_listreceivedbyaddress_%22address%22_(_minconf_))
...
### `z_listunspent ( minconf maxconf includeWatchonly ["zaddr",...] )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_listunspent_(_minconf_maxconf_includeWatchonly_[%22zaddr%22,...]_))
...
1. minconf (numeric, optional, default=1) The minimum confirmations to filter
2. maxconf (numeric, optional, default=9999999) The maximum confirmations to filter
3. includeWatchonly (bool, optional, default=false) Also include watchonly addresses (see 'z\_importviewingkey')
...
### `z_mergetoaddress ["fromaddress", ... ] "toaddress" ( fee ) ( transparent_limit ) ( shielded_limit ) ( memo )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_mergetoaddress_[%22fromaddress%22,_..._]_%22toaddress%22_(_fee_)_(_transparent_limit_)_(_shielded_limit_)_(_memo_))

WARNING: z\_mergetoaddress is disabled.
...
4. transparent\_limit (numeric, optional, default=50) Limit on the maximum number of UTXOs to merge. Set to 0 to use node option -mempooltxinputlimit (before Overwinter), or as many as will fit in the transaction (after Overwinter).
5. shielded\_limit (numeric, optional, default=20 Sprout or 200 Sapling Notes) Limit on the maximum number of notes to merge. Set to 0 to merge as many as will fit in the transaction.
...
### `z_sendmany "fromaddress" [{"address":... ,"amount":...},...] ( minconf ) ( fee )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_sendmany_%22fromaddress%22_[{%22address%22:..._,%22amount%22:...},...]_(_minconf_)_(_fee_))
...
### `z_shieldcoinbase "fromaddress" "tozaddress" ( fee ) ( limit )`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_shieldcoinbase_%22fromaddress%22_%22tozaddress%22_(_fee_)_(_limit_))
...
### `z_viewtransaction "txid"`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#z_viewtransaction_%22txid%22)
...
### `zcbenchmark benchmarktype samplecount`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#zcbenchmark_benchmarktype_samplecount)
...
### `zcrawjoinsplit rawtx inputs outputs vpub_old vpub_new`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#zcrawjoinsplit_rawtx_inputs_outputs_vpub_old_vpub_new)
...
Outputs are confidential between sender/receiver. The vpub\_old and vpub\_new values are globally public and move transparent value into or out of the confidential value store, respectively.
...
### `zcrawkeygen`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#zcrawkeygen)
...
### `zcrawreceive zcsecretkey encryptednote`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#zcrawreceive_zcsecretkey_encryptednote)
...
### `zcsamplejoinsplit`[¶](https://wiki.verus.io/\#!faq-cli/clifaq-02_verus_commands.md\#zcsamplejoinsplit)
...
© 2020 The Verus Foundation. Website generated with [MDwiki](http://www.mdwiki.info/) © Timo Dörr and contributors.